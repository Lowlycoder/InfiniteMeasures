<div class="container my-3">
    ...
    <form class="flex-column">
        <div style="column-count: 2">
                ...
                <input type="radio" id="appartement" name="log1" value="1190">
                <label for="appartement">Appartement</label><br>
                <input type="radio" id="maison" name="log1" value="1179,82">
                <label for="maison">Maison</label><br>

                <h4 class="mb-1">Combien êtes-vous chez vous ?</h4>
                <input type="radio" id="combien1" name="log2" value="196,64">
                <label for="combien1">1</label>
                <input type="radio" id="combien2" name="log2" value="393,28">
                <label for="combien2">2</label>
                <input type="radio" id="combien3" name="log2" value="589,92">
                <label for="combien3">3</label>
                <input type="radio" id="combien4" name="log2" value="786,56">
                <label for="combien4">4</label>
                <input type="radio" id="combien5" name="log2" value="983,2">
                <label for="combien5">5 ou plus</label>

                <h4 class="mb-1">Quel est le mode de chauffage de votre habitation ?</h4>
                <input type="radio" id="electricite" name="log3" value="1684">
                <label for="electricite">Électricité</label><br>
                <input type="radio" id="gaz" name="log3" value="1684">
                <label for="gaz">Pompe à chaleur</label><br>
                <input type="radio" id="autre" name="log3" value="200">
                <label for="autre">Autre</label><br>

                <h4 class="mb-1">Le plus souvent vous prenez ?</h4>
                <input type="radio" id="douche" name="log4" value="119">
                <label for="douche">Douche</label><br>
                <input type="radio" id="bain" name="log4" value="510">
                <label for="bain">Bain</label><br>

                <h4 class="mb-1">Combien d'électroménager avez-vous ?</h4>
                <input type="radio" id="5moins" name="log5" value="300">
                <label for="5moins">Entre 1 et 5</label><br>
                <input type="radio" id="entre5_10" name="log5" value="500">
                <label for="entre5_10">Entre 5 et 10</label><br>
                <input type="radio" id="10plus" name="log5" value="1000">
                <label for="10plus">Plus de 10</label><br>

                <h4 class="mb-1">Comment faites-vous votre vaisselle ?</h4>
                <input type="radio" id="main" name="log6" value="150">
                <label for="main">A la main</label><br>
                <input type="radio" id="lave-vaisselle" name="log6" value="5000">
                ...
                <input type="radio" id="trie_oui" name="Dec1" value="300">
                <label for="trie_oui">Oui</label><br>
                <input type="radio" id="trie_quelquesfois" name="Dec1" value="500">
                <label for="trie_quelquesfois">Quelques fois</label><br>
                <input type="radio" id="trie_non" name="Dec1" value="1000">
                <label for="trie_non">Non</label><br>

                <h4 class="mb-1">Faites-vous du compostage ?</h4>
                <input type="radio" id="compost_oui" name="Dec2" value="10">
                <label for="compost_oui">Oui</label><br>
                <input type="radio" id="compost_parfois" name="Dec2" value="150">
                <label for="compost_parfois">Parfois</label><br>
                <input type="radio" id="compost_non" name="Dec2" value="200">
                ...
                <input type="radio" id="résidus_oui" name="Dec3" value="10">
                <label for="résidus_oui">Oui</label><br>
                <input type="radio" id="résidus_parfois" name="Dec3" value="150">
                <label for="résidus_parfois">Parfois</label><br>
                <input type="radio" id="résidus_non" name="Dec3" value="300">
                ...
                <input type="radio" id="reconditionné_oui" name="Ach1" value="200">
                <label for="reconditionné_oui">Oui</label><br>
                <input type="radio" id="reconditionné_parfois" name="Ach1" value="500">
                <label for="reconditionné_parfois">Parfois</label><br>
                <input type="radio" id="reconditionné_non" name="Ach1" value="900">
                <label for="reconditionné_non">Non</label><br>

                <h4 class="mb-1">Combien de fois achetez-vous de nouveaux vêtements par an ?</h4>
                <input type="radio" id="1_fois" name="Ach2" value="200">
                <label for="1_fois">1 fois</label><br>
                <input type="radio" id="2_fois" name="Ach2" value="400">
                <label for="2_fois">2 fois</label><br>
                <input type="radio" id="3_fois+" name="Ach2" value="1000">
                <label for="3_fois+">3 fois ou plus</label><br>

                <h4 class="mb-1">Achetez-vous de la seconde-main ?</h4>
                <input type="radio" id="jamais" name="Ach3" value="500">
                <label for="jamais">Jamais</label><br>
                <input type="radio" id="1_2fois" name="Ach3" value="200">
                <label for="1_2fois">1 à 2 fois par an</label><br>
                <input type="radio" id="souvent" name="Ach3" value="100">
                <label for="souvent">Souvent</label><br>
                <input type="radio" id="toujours" name="Ach3" value="50">
                <label for="toujours">Toujours</label><br>

            <h2 class="text-blue"><u>Transports</u></h2>
            <h4 class="mb-1">Avez-vous une voiture ?</h4>
            <input type="radio" id="voiture_oui" name="Trans1" value="1000">
            <label for="voiture_oui">Oui</label><br>
            <input type="radio" id="voiture_non" name="Trans1" value="100">
            <label for="voiture_non">Non</label><br>

                <h4 class="mb-1">Combien de fois prenez-vous l'avion par an ?</h4>
                <input type="radio" id="jamais" name="Trans2" value="0">
                <label for="jamais">Jamais</label><br>
                <input type="radio" id="1fois" name="Trans2" value="100">
                <label for="1fois">1 fois</label><br>
                <input type="radio" id="2fois" name="Trans2" value="200">
                <label for="2fois">2 fois</label><br>
                <input type="radio" id="3fois" name="Trans2" value="300">
                <label for="3fois">3 fois ou plus</label><br>

                <h4 class="mb-1">Comment vous rendez-vous au travail ?</h4>
                <input type="radio" id="transports" name="Trans3" value="1180">
                <label for="transports">En transports en commun</label><br>
                <input type="radio" id="voiture" name="Trans3" value="1200">
                <label for="voiture">En voiture</label><br>
                <input type="radio" id="vélo" name="Trans3" value="500">
                <label for="vélo">En vélo</label><br>
                <input type="radio" id="pied" name="Trans3" value="1">
                <label for="pied">À pied</label><br>
                <input type="radio" id="télétravail" name="Trans3" value="1">
                ...
                <input type="radio" id="vegetarien" name="Alim1" value="1">
                <label for="vegetarien">Végétarien</label><br>
                <input type="radio" id="vegan" name="Alim1" value="1">
                <label for="vegan">Végan</label><br>
                <input type="radio" id="vegetalien" name="Alim1" value="5">
                <label for="vegetalien">Végétalien</label><br>
                <input type="radio" id="flexitarien" name="Alim1" value="150">
                <label for="flexitarien">Flexitarien</label><br>

                <h4 class="mb-1">Combien de fois faites-vous vos courses par semaine ?</h4>
                <input type="radio" id="1fois" name="Alim2" value="200">
                <label for="1fois">1 fois</label><br>
                <input type="radio" id="2fois" name="Alim2" value="400">
                <label for="2fois">2 fois</label><br>
                <input type="radio" id="3fois+" name="Alim2" value="700">
                <label for="3fois+">3 fois ou plus</label><br>

                <h4 class="mb-1">Quel pourcentage de la nourriture que vous achetez finit à la poubelle ?(par mois)</h4>
                <input type="radio" id="zero" name="Alim3" value="0">
                <label for="zero">0%</label><br>
                <input type="radio" id="entre0_30" name="Alim3" value="200">
                <label for="entre0_30">Entre 0 et 30%</label><br>
                <input type="radio" id="entre30_50" name="Alim3" value="300">
