<header style="border-bottom: 2px solid lightgray">
    <nav class="py-2 flex-row">
        <div class="container-xl">
            <div class="d-sm-flex align-items-center">
                <a href="/">
                    <img src="<?= BASE_URL_ASSETS; ?>images/isante.png" alt="logo" height=47px" width="132">
                </a>
                <a href="/fun-facts" class="nav-link">Fun Fact</a>
