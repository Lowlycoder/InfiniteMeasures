...
<div class="container">
    <div class="connect">
        ...
        <form method="POST">
            ...
            <input type="text" name="lastName" id="lastName" placeholder="John " style="font-size: 1rem"
                   value="<?php echo $lastName; ?>">

            <label for="name">Prénom</label>
            <input type="text" name="firstName" id="firstname" placeholder="Jones" style="font-size: 1rem"
                   value="<?php echo $firstName; ?>">

            <label for="email">Email</label>
            <input type="text" name="email" id="email" placeholder="example@example.com" style="font-size: 1rem"
                   value="<?php echo $mail; ?>">

            <label for="pwd">Mot de passe</label>
            <input type="password" name="password" id="pwd" placeholder="Mot de passe" style="font-size: 1rem"
                   value="<?php echo $passwordHash; ?>">
